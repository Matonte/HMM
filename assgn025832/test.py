...
print  (num_errors_baseline/num_words_test)
print ("Fraction of errors (Viterbi):")
print (num_errors/num_words_test)
print ("Tags suggested by Baseline Algorithm:")
print ( output_li_baseline)
print ("Tags suggested by Viterbi Algorithm:")
print ( output_li)
print ("Correct tags:")
print (test_li_tags)
